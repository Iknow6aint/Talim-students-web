...
export function Header({ onMenuClick }: { onMenuClick: () => void }) {
  return (
    <header className="font-manrope bg-[#FBFBFB] px-5 border-b sm:border-b-2 border-b-[#F0F0F0] pb-4">
        ...
        <div className="flex items-center w-full sm:w-auto justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="flex gap-2 items-center text-sm text-[#6F6F6F] p-2 rounded-lg border border-[#F0F0F0] bg-white">
              <p className="text-[16px]">12 Oct, 2024</p>
              <CalendarRange size={24} />
            </div>
            <Button className="bg-white shadow-none border border-[#F0F0F0] h-full rounded-lg p-3">
